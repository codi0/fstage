...
//load ionic assets
await importr('https://cdn.jsdelivr.net/npm/@ionic/core@8.1.0/css/ionic.bundle.min.css');
await importr('https://cdn.jsdelivr.net/npm/@ionic/core@8.1.0/dist/ionic/ionic.esm.min.js');
