...
var _modules = [ 'animator', 'component', 'dom', 'env', 'form', 'gestures', 'history', 'hls', 'http', 'ipfs', 'lit', 'observe', 'pubsub', 'registry', 'router', 'store', 'sync', 'transitions', 'utils', 'webpush', 'websocket' ];
